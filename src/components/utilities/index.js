...
const customTooltips = (context) => {
  // Tooltip Element
  let chartContainer = context.chart.canvas.closest(
    ".hexadash-chart-container"
  );
  let tooltipEl = chartContainer?.querySelector(".chartjs-tooltip") || null;
  ...
  const toolTip =
    chartContainer && chartContainer.querySelector(".chartjs-tooltip");
